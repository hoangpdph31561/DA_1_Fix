...
{
    public class BillViewModelForService : ViewModelBase<Guid>
    {
        private readonly IBillReadOnlyRespository _billReadOnlyRespository;
        private readonly ILocalizationService _localizationService;
        public BillViewModelForService(IBillReadOnlyRespository billReadOnlyRespository, ILocalizationService localizationService)
        {
        ...
        public async override Task HandleAsync(Guid id, CancellationToken cancellationToken)
        {
            try
            {
                var result = await _billReadOnlyRespository.GetBillByIdForServiceAsync(id, cancellationToken);
