...
{
    public class BillsByOtherForRoomViewModel : ViewModelBase<ViewBillWithPaginationRequest>
    {
        private readonly IBillReadOnlyRespository _billReadOnlyRespository;
        private readonly ILocalizationService _localizationService;
        public BillsByOtherForRoomViewModel(IBillReadOnlyRespository billReadOnlyRespository, ILocalizationService localizationService)
        {
        ...
        public async override Task HandleAsync(ViewBillWithPaginationRequest request, CancellationToken cancellationToken)
        {
            try
            {
                var result = await _billReadOnlyRespository.GetBillsByOtherForRoom(request, cancellationToken);
