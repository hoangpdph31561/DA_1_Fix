...
{
    public class BillListWithPaginationByOtherViewModel : ViewModelBase<ViewBillWithPaginationRequest>
    {
        private readonly IBillReadOnlyRespository _billReadOnlyRespository;
        private readonly ILocalizationService _localizationService;
        public BillListWithPaginationByOtherViewModel(IBillReadOnlyRespository billReadOnlyRespository, ILocalizationService localizationService)
        {
        ...
        public async override Task HandleAsync(ViewBillWithPaginationRequest request, CancellationToken cancellationToken)
        {
            try
            {
                var result = await _billReadOnlyRespository.GetBillsByOtherAsync(request, cancellationToken);
