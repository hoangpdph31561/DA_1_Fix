...
{
    public class ServiceOrderDetailListWithPaginationViewModelByOther : ViewModelBase<ViewServiceOrderDetailWithPaginationRequest>
    {
        private readonly IServiceOrderDetailReadOnlyRespository _serviceOrderDetailReadOnly;
        private readonly ILocalizationService _localizationService;
        public ServiceOrderDetailListWithPaginationViewModelByOther(IServiceOrderDetailReadOnlyRespository serviceOrderDetailReadOnly, ILocalizationService localizationService)
        {
        ...
        public async override Task HandleAsync(ViewServiceOrderDetailWithPaginationRequest request, CancellationToken cancellationToken)
        {
            try
            {
                var result = await _serviceOrderDetailReadOnly.GetServiceOrderDetailsByOtherAsync(request, cancellationToken);
