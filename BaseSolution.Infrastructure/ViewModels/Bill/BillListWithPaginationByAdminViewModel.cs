...
{
    public class BillListWithPaginationByAdminViewModel : ViewModelBase<ViewBillWithPaginationRequest>
    {
        private readonly IBillReadOnlyRespository _billReadOnlyRespository;
        private readonly ILocalizationService _localizationService;
        public BillListWithPaginationByAdminViewModel(IBillReadOnlyRespository billReadOnlyRespository, ILocalizationService localizationService)
        {
        ...
        public async override Task HandleAsync(ViewBillWithPaginationRequest request, CancellationToken cancellationToken)
        {
            try
            {
                var result = await _billReadOnlyRespository.GetBillsByAdminAsync(request, cancellationToken);
