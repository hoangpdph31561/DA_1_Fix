...
{
    public class ServiceOrderListWithPaginationViewModelByAdmin : ViewModelBase<ViewServiceOrderWithPaginationRequest>
    {
        private readonly IServiceOrderReadOnlyRespository _serviceOrderReadOnly;
        private readonly ILocalizationService _localizationService;
        public ServiceOrderListWithPaginationViewModelByAdmin(IServiceOrderReadOnlyRespository serviceOrderReadOnly, ILocalizationService localizationService)
        {
        ...
        public async override Task HandleAsync(ViewServiceOrderWithPaginationRequest request, CancellationToken cancellationToken)
        {
            try
            {
                var result = await _serviceOrderReadOnly.GetServicesByAdminAsync(request, cancellationToken);
