...
{
    public class ServiceListWithPaginationViewModel : ViewModelBase<ViewServiceWithPaginationRequest>
    {
        public readonly IServiceReadOnlyRepository _ServiceReadOnlyRepository;
        private readonly ILocalizationService _localizationService;

        public ServiceListWithPaginationViewModel(IServiceReadOnlyRepository ServiceReadOnlyRepository, ILocalizationService localizationService)
        {
        ...
        public override async Task HandleAsync(ViewServiceWithPaginationRequest request, CancellationToken cancellationToken)
        {
            try
            {
                var result = await _ServiceReadOnlyRepository.GetServiceWithPaginationByAdminAsync(request, cancellationToken);
