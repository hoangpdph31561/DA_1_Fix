    ...
    public class RoomTypeProfile : Profile
    {
        public RoomTypeProfile()
        {
            CreateMap<RoomTypeEntity, RoomTypeDTO>()
                ...
                .ForMember(dest => dest.NumberOfAmenities, opt => opt.MapFrom(src =>src.AmenityRoomDetails == null || !src.AmenityRoomDetails.Any() ? 0 : src.AmenityRoomDetails.Sum(ard => ard.Amount)));
